...
export class DatingAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // 2. Uncomment the lines below and add your certificate ARN
    // 3. Add your custom domain name
    // 4. Deploy the stack
    // 5. Add DNS records pointing to CloudFront
    // See: cdk/CUSTOM-DOMAIN-SETUP.md for detailed instructions
    
    // Uncomment and configure these lines for custom domain:
    ...
    const distribution = new cloudfront.Distribution(this, 'Distribution', {
      // Uncomment these lines for custom domain:
    ...
    // Uncomment for custom domain output:
    // new cdk.CfnOutput(this, 'CustomDomainURL', {
    //   value: `https://${customDomain}`,
    //   description: 'Custom Domain URL',
    //   exportName: 'DatingAppCustomURL',
    // });
  }
}
